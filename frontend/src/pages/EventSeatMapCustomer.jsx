        ...
        <div className="tier-grid">
          ...
          {tierCards.map((tier) => (
            ...
            >
              ...
              <strong className="tier-price">{formatPrice(tier.minPrice)}</strong>
              <span className="tier-copy">Starting price</span>
      ...
      <section className="events-panel">
        <div className="events-panel-header">
          <div>
            ...
            <p className="panel-copy">
              Green = available, red = taken, gold = special policy seats, grey = resale listing.
            </p>
          </div>
          <span className="seats-badge">{availableCount} seats available</span>
        </div>
        ...
        <div className="seat-map-shell">
          ...
          <div className="legend">
            ...
            <span className="legend-item"><span className="dot warn" /> Premium seat policy</span>
          </div>
        </div>
      ...
      {yellowSeatWarning ? (
        <div className="modal-overlay" onClick={() => setYellowSeatWarning(null)}>
          <div className="modal-content" onClick={(event) => event.stopPropagation()}>
            <h2 className="modal-title">Seat Policy Notice</h2>
            <p className="modal-text">
              You&apos;ve selected seat <strong>{yellowSeatWarning.row}{yellowSeatWarning.seatId}</strong>, which has a <strong>special ticket policy</strong>.
            </p>
            <p className="modal-text">
              This ticket is meant for direct personal use and can&apos;t be reassigned after purchase.
            </p>
...
export default EventSeatMapCustomer;
